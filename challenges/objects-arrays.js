...
console.log(dinosaursTy.weight);

// What was the diet of a velociraptor?
console.log(dinosaursVe.diet);

// How long was a stegosaurus?
console.log(dinosaursSt.length);

// What time period did tyrannosaurus live in?
console.log(dinosaursTy.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.

dinosaursSt.roar = function() {
  return "RAWERSRARARWERSARARARRRR!"
}

console.log(dinosaursSt.roar());
...
const universities = [];
graduates.forEach(list => universities.push(`${list.university}`));
universities.sort();
...
const lowPopulationAnimals = zooAnimals.filter(size => size.population < 5);
...
populationTotal = zooAnimals.reduce((animal, total) => animal += total.population, 0);
